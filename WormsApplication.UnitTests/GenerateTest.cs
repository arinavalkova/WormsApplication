...
namespace WormsApplication.UnitTests
{
    public class GenerateTest
    {
        ...
        public void GenerateCommandTest_LuckyTry_AnotherWorm()
        {
            ...
            var world = new WorldHandler(new MockFoodGenerator(), namesGenerator, new List<Worm> {worm1});
        ...
        public void GenerateCommandTest_NotEnoughVitality_NoAnotherWorm()
        {
            ...
            var world = new WorldHandler(new MockFoodGenerator(), namesGenerator, new List<Worm> {worm});
